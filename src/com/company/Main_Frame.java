...
public class Main_Frame extends JFrame {
    ...
    private void addRadioButton(String name, final int formula_number)           // радиокнопки для формул
    {
        ...
        button.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent actionEvent)
            {
                ...
                if (formula_number == 1)	image.setIcon(new ImageIcon(Main_Frame.class.getResource("formula1.jpg")));
                if (formula_number == 2) image.setIcon(new ImageIcon(Main_Frame.class.getResource("formula2.jpg")));
            }
        });
    ...
    public Main_Frame() {
        ...
        Image img = kit.getImage("src\\com.company\\calcul.png");
        setIconImage(img);
        ...
        image = new JLabel(new ImageIcon(Main_Frame.class.getResource("formula1.jpg")));
        picture.add(image);
        picture.add(Box.createHorizontalGlue());
        ...
        result_area.add(Box.createHorizontalGlue());
        result_area.setBorder(BorderFactory.createLineBorder(Color.YELLOW));
